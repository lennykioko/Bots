...
bool CheckBuyConditions() {
   ...
   // 5. Stronger trend confirmation - price above MA50 on higher timeframe
   bool strongTrend = CheckIsAboveSMA(currentPrice, 50, PERIOD_M15);

   return aboveMiddle && aboveMA && swingHighTaken && aboveFVGHigh && strongTrend;
}
...
bool CheckSellConditions() {
   ...
   // 5. Stronger trend confirmation - price below MA50 on higher timeframe
   bool strongTrend = !CheckIsAboveSMA(currentPrice, 50, PERIOD_M15);

   return belowMiddle && belowMA && swingLowTaken && belowFVGLow && strongTrend;
}
